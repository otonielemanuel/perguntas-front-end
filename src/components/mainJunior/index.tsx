...
const juniordata: FAQItem[] = [
  {
    id: 1,
    pergunta: "1. O que é SQL injection?",
    resposta:
  ...
  {
    id: 2,
    pergunta: "2.	O que é escopo em JavaScript?",
    resposta:
  ...
  {
    id: 4,
    pergunta: "4.	Como JavaScript e jQuery são diferentes?",
    resposta:
  ...
  {
    id: 5,
    pergunta: "5.	O que é um Callback Hell?",
    resposta:
  ...
  {
    id: 6,
    pergunta: "6.	O que é Cross-Site Scripting (XSS)?",
    resposta:
  ...
  {
    id: 9,
    pergunta: "9.	O que é encapsulamento?",
    resposta:
  ...
  {
    id: 10,
    pergunta: "10.	Qual o ponto de se usar Redux?",
    resposta:
  ...
  {
    id: 11,
    pergunta: "11.	Explique a diferença de null e undefined em JavaScript.",
    resposta:
  ...
  {
    id: 12,
    pergunta: "12.	Liste as vantagens da arquitetura de microsserviços.",
    resposta:
  ...
  {
    id: 13,
    pergunta: "13.	Quais são as vantagens do NoSQL sobre o RDBMS tradicional?",
    resposta:
  ...
  {
    id: 14,
    pergunta: "14.	O que é programação reativa?",
    resposta:
  ...
  {
    id: 15,
    pergunta: "15.	O que são os reducers no Redux?",
    resposta:
  ...
  {
    id: 16,
    pergunta: "16.	Qual o papel do HTML na indexação de páginas por buscadores?",
    resposta:
  ...
  {
    id: 20,
    pergunta: "20.	Qual o significado de Mock?",
    resposta:
  ...
  {
    id: 21,
    pergunta: "21.	O que é o esquema do GraphQL?",
    resposta:
  ...
  {
    id: 22,
    pergunta: "22.	O que é o Virtual DOM? Qual sua vantagem?",
    resposta:
  ...
  {
    id: 26,
    pergunta: "26.	O que é serverless computing?",
    resposta:
  ...
  {
    id: 27,
    pergunta: "27.	Quais são os tipos primitivos do JavaScript?",
    resposta:
      "Os tipos primitivos do JavaScript são: Number, String, Boolean, Undefined, Null e Symbol.",
  },
  {
    id: 28,
    pergunta: "28.	Qual a diferença entre inline and inline-block?",
    resposta:
