  ...
  return (
    <styles.Main>
      ...
      <styles.Texts>
        ...
        <styles.Paragraph>As perguntas formam retiradas do github do <a href="" className='gitlink'>Ruben Paschoarelli</a>. Essas Perguntas têm o intuito de ser uma base para entrevistas e candidatos se nivelarem, em entrevistas de emprego.</styles.Paragraph>
